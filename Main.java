 ...
 * @Sept 25, 2023
 */
public class Main extends OrderedPair
{
    public static void main(String args[]) {
        ...
        OrderedPair roots = Functions.findQuadraticRoots(a, b, c);
        ...
        double slope = Functions.findSlope(p1,p2);
        ...
        System.out.println("The midpoint between (" + p1 + ") and (" + p2 + ") is (" + Functions.findMidpoint(p1,p2) + ").");
        System.out.println();
        ...
        double sum = Functions.findArithmeticSeriesSum(a1, d, k);
        ...
        double sum2 = Functions.findGeometricSeriesSum(a1, r, k);
        ...
        int n = input.nextInt();
        System.out.println("Rolling a " + n + "-sided die... you got a " + Functions.rollDie(n) + "!");
    }
}
